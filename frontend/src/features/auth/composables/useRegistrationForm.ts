...
import { registerSchema, type CheckAvailabilityDto } from "../auth.schemas.ts"
...
import type { CheckAvailabilityResult } from "../auth.types"
import type { RegistrationStep } from "../auth.types.ts"
