  ...
  <MinimalLayout class="grid grid-cols-12 items-stretch">
    <main lang="ru" class="col-span-12 lg:col-span-8 2xl:col-start-4 2xl:col-span-6">
      ...
      >
        ...
        >
          <span class="
            hidden lg:inline absolute -left-5 pr-2 text-brand opacity-0 group-hover:opacity-100
    ...
    <nav
      ref="sheetRef"
      class="fixed flex lg:hidden flex-col top-1/2 right-2 -translate-y-1/2 overflow-hidden will-change-transform
    ...
    <aside class="hidden lg:flex col-start-9 col-span-4 2xl:col-start-10 2xl:col-span-3 justify-center ml-2">
      <section class="
        sticky top-2 self-start px-4 xl:px-10 py-2.75 xl:py-7.5 max-w-120 bg-card rounded-[13.5px]
        xl:rounded-[35px] border border-border
      ">
    ...
    <footer class="
      col-span-12 lg:col-start-2 lg:col-span-10 flex xl:col-start-3 xl:col-span-8 2xl:col-start-4 2xl:col-span-6
      flex-col gap-2 sm:flex-row justify-between text-xs sm:text-sm mt-6 px-4 lg:px-10 py-2.75 lg:py-7.5
      rounded-[13.5px] lg:rounded-[35px] border border-border bg-card
    ">
