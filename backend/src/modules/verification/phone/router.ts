...
import { validate, optionalAuthMiddleware } from "@/shared/middlewares/index.js"
...
phoneVerificationRouter.post("/verify", validate(verifySchema, "body"), optionalAuthMiddleware, phoneVerificationController.verify)
...
phoneVerificationRouter.post("/send", validate(sendSchema, "body"), optionalAuthMiddleware, phoneVerificationController.send)